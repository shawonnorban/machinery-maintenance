...
return [
    ...
    'revoke_client_title' => 'Revoke :name?',
    'revoke_client_description' => 'The row stays for the audit trail; every token minted from it stops working immediately.',
    'new_secret' => 'New secret',
    'live_tokens_count' => ':count live tokens',
    'credential_created' => 'Credential created',
    'credential_created_hint' => 'Copy the client id and secret now — the secret will not be shown again.',
    'back_to_clients' => 'Back to API clients',
    'scopes_default_hint' => 'Nothing is ticked by default — a credential that can do nothing is the safe reading.',
    'save_scopes' => 'Save scopes',
    'create_credential' => 'Create credential',
    'new_credential' => 'New credential',
    'new_machine_credential' => 'New machine credential',
    'narrowing_hint' => 'Narrowing removes the wider access from every token already minted.',
];
