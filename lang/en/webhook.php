...
return [
    ...
    'no_endpoints_found' => 'No webhook endpoints yet.',
    'delete_endpoint_title' => 'Delete :url?',
    'delete_endpoint_description' => 'This pauses the endpoint rather than erasing its delivery history.',
    'endpoint_paused_toast' => 'Endpoint paused',
    'go_to_endpoint' => 'Go to the endpoint',
    'url_hint' => 'Must be a reachable public HTTPS address — a private/internal address is refused.',
    'save_changes' => 'Save changes',
    'create_endpoint' => 'Create endpoint',
    'new_signing_secret' => 'New signing secret',
    'page_description' => 'Outgoing integrations — where this system tells another one what just happened.',
    'new_webhook_endpoint' => 'New webhook endpoint',
    'recent_deliveries' => 'Recent deliveries',
    'last_attempt' => 'Last attempt',
    'no_deliveries_found' => 'No deliveries yet.',
    'redelivery_queued' => 'Redelivery queued',
    'edit_webhook_endpoint' => 'Edit webhook endpoint',
];
